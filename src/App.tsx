...
import { guideBackLink, guidesData } from "./data/guidesData";
...
const App = ({ url }: { url?: string }) => {
  const pages = guidesData;
  const backLink = guideBackLink;
        ...
        <Router location={url}>
          <Layout>
            <Routes>
              ...
              <Route path="/guide/apparence" element={<GuideLinks page={pages.apparence} backLink={backLink} />} />
              ...
              <Route path="/guide/actualites" element={<GuideLinks page={pages.actualites} backLink={backLink} />} />
              <Route path="/guide/actualites/publier-une-video" element={<PublierUneVideo />} />
  
              <Route path="/guide/clients" element={<GuideLinks page={pages.clients} backLink={backLink} />} />
              <Route path="/guide/clients/import-en-masse" element={<ImportEnMasse />} />
  
              <Route path="/guide/commandes" element={<GuideLinks page={pages.commandes} backLink={backLink} />} />
              ...
              <Route path="/guide/produits" element={<GuideLinks page={pages.produits} backLink={backLink} />} />
              ...
              <Route path="/guide/statistiques" element={<GuideLinks page={pages.statistiques} backLink={backLink} />} />
